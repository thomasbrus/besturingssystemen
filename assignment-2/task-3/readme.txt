...
============================================================================================================================
  ...
  Also, we provided [additional tests]
  (https://github.com/thomasbrus/besturingssystemen/blob/master/assignment-2/task-3/task.c#L104-149) in task.c which can be 
  run by uncommenting the main function in task.c.
